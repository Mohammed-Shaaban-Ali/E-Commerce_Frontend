          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <div className="footer-link d-flex flex-column">
                <Link className="text-white-50 py-2 mb-1">Privacy Policy</Link>
                <Link className="text-white-50 py-2 mb-1">Refund Policy</Link>
                <Link className="text-white-50 py-2 mb-1">Shipping Policy</Link>
                <Link className="text-white-50 py-2 mb-1">
                  Terms Of Servlice
                </Link>
                <Link className="text-white-50 py-2 mb-1">Blogs</Link>
              </div>
            </div>
